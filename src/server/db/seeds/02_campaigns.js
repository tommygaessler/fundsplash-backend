  ...
  return knex('photographers').then(photographers => {
    return Promise.all([
      ...
      .insert({
        ...
        description: 'Spain has always been my dream! I have wanted to go there forever! I have reserched the best places to go take pictures and cannot wait to share them with everybody!',
        goal: 10000,
        raised: 20000,
      ...
      .insert({
        ...
        description: 'I want to go to Israel because of all the history. There are so many great places to see, such as the Dead Sea, Tel Aviv, and Jerusalem!',
        goal: 9000,
        raised: 5000,
      ...
      .insert({
        ...
        description: 'There is a lack of photos from South America on Unsplash. My goal is to show how beautiful this country is!',
        goal: 2000,
        raised: 100,
